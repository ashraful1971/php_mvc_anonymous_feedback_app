                    ...
                    <div class="mt-10 mx-auto w-full max-w-xl">
                        ...
                        <form class="space-y-6" action="<?php __(url('/register')) ?>" method="POST">
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <input id="confirm_password" name="confirm_password" type="password" required class="px-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                        ...
                        <p class="mt-10 text-center text-sm text-gray-500">
                            ...
                            <a href="<?php __(url('/login')) ?>" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Login!</a>
                        </p>
                    </div>
                </div>
            </div>
